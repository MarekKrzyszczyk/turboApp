...
class UserMapperTest {
    ...
    public static void setUp() {
        ...
        List<Role> firstUserRoles = new ArrayList<>();
        ...
        List<Workgroup> firstUserWorkgroups = new ArrayList<>();
        ...
        List<Role> secondUserRoles = new ArrayList<>();
        ...
        List<Workgroup> secondUserWorkgroups = new ArrayList<>();
        ...
        List<RoleDto> firstUserDtoRoles = new ArrayList<>();
        ...
        List<WorkgroupDto> firstUserDtoWorkgroups = new ArrayList<>();
        ...
        List<RoleDto> secondUserDtoRoles = new ArrayList<>();
        ...
        List<WorkgroupDto> secondUserDtoWorkgroups = new ArrayList<>();
